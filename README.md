...
This project is designed to simulate the type of workflow used in:
...
It is especially relevant for pharma and healthcare data roles.

---

## Resume / Portfolio Bullet

> Built a synthetic clinical trial data review and NLP workflow using SQL, Python, and unsupervised text clustering to simulate study reporting, safety review, protocol deviation monitoring, and operational incident analysis.